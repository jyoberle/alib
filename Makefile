...
ALIBDIR = $(abspath alib)

CCFLAGS = -MP -MMD -m68000 -Ofast -nostdlib -Wextra -Wno-unused-function -Wno-volatile-register-var -fomit-frame-pointer -fno-tree-loop-distribution -flto -fno-exceptions -I${MUISDKDIR} \
-fno-builtin -I$(ALIBDIR) -I$(ALIBDIR)/include -D__stdargs= -DNDEBUG
